...
class CreateMaintsPlanningsActivitesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('maints_plannings_activites', function (Blueprint $table) {
            ...
            $table->integer('maints_plannings_id')->index('fk_maints_plannings_activites_maints_plannings1_idx');
            $table->string('rapport_statut', 45)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('maints_plannings_activites');
    }
}
