...
class CreateMaintsPlanningsRapportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('maints_plannings_rapports', function (Blueprint $table) {
            ...
            $table->integer('maints_plannings_activites_id')->index('fk_maints_plannings_rapports_maints_plannings_activites1_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('maints_plannings_rapports');
    }
}
