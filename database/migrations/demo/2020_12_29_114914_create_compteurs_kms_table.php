...
class CreateCompteursKmsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('compteurs_kms', function (Blueprint $table) {
            $table->integer('id', true);
            $table->string('marque', 45)->nullable();
            $table->string('matricule', 45)->nullable();
            $table->string('kilometrage', 45)->nullable();
            $table->string('horometre', 45)->nullable();
    ...
    {
        Schema::dropIfExists('compteurs_kms');
    }
}
