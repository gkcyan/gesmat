...
class CreatePcesDetsCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pces_dets_categories', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pces_dets_categories');
    }
}
