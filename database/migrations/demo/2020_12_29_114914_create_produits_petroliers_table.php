...
class CreateProduitsPetroliersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('produits_petroliers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('produits_petroliers');
    }
}
