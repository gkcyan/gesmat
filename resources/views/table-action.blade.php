<div class="flex justify-around ">
    <button wire:click="read({{$id}})" class="px-2 py-1 font-bold text-white bg-teal-500 rounded hover:bg-teal-700">
    ...
    <button wire:click="edit({{$id}})" class="px-2 py-1 font-bold text-white bg-blue-500 rounded hover:bg-blue-700">
    ...
    <button wire:click="delete({{$id}})" class="px-2 py-1 font-bold text-white bg-red-500 rounded hover:bg-red-700">
