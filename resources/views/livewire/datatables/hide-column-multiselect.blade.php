<div x-data="{ show: false }" class="flex flex-col items-center">
    <div class="relative flex flex-col items-center">
        ...
        <div x-show="show" x-on:click.away="show = false" class="absolute right-0 z-40 z-50 mt-16 -mr-4 overflow-y-auto bg-white rounded shadow-2xl top-100 w-96 max-h-select" x-cloak>
